  ...
  return (
    <div className="mx-auto flex w-full max-w-4xl flex-col gap-6">
      <div className="flex flex-col items-center gap-3 rounded-2xl border border-panel-foreground/10 bg-panel p-6 text-center text-panel-foreground shadow-sm">
        <h1 className="text-2xl font-extrabold text-panel-foreground sm:text-3xl">
        ...
        <p className="text-sm text-panel-muted">
          Roles are dealt secretly once the game starts. The host can start once at least{" "}
          {MIN_PLAYERS_TO_START} players are seated.
        </p>
      </div>
